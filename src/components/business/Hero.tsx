...
<div className="flex-1 text-center md:text-left z-10 w-full">
  ...
  {/* TOP BADGE (FIXED - MORE PREMIUM + STANDARD) */}
  ...
  {/* SUBTEXT (OPTIMIZED MOBILE READABILITY ONLY) */}
  ...
  <span className="block mt-1 text-white/75">
    Every pizza is prepared only after you order.
  </span>

  <span className="block mt-1 font-bold text-[rgb(var(--primary))]">
    Hot delivery in around 30 minutes.
  </span>
...
Thank you!`
  ...
  {/* TRUST BADGES (RESTORED + MOBILE FRIENDLY) */}
        ...
        <div className="flex-1 w-full max-w-[320px] md:max-w-[550px]">
          ...
          <div className="relative">
            ...
            <div className="relative w-full aspect-square rounded-2xl overflow-hidden border-2 border-[rgb(var(--primary))]/30">
              ...
              {/* FIXED FLOATING LABEL (ONE LINE ALWAYS) */}
